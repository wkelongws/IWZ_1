...
public class IWZavgspeed20s extends Configured implements Tool {
	
	public static void main ( String[] args ) throws Exception {
		
		int res = ToolRunner.run(new Configuration(), new IWZavgspeed20s(), args);
		System.exit(res); 
	...
	public int run ( String[] args ) throws Exception {
		...
		job_one.setJarByClass(IWZavgspeed20s.class); 
